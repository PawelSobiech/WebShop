...
<html lang="pl">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(myimages/about.jpg);">						
					</div>
					<div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Witamy na stronie sklepu WędkaVendor!</h2>
	            </div>
	          </div>
						<div class="pb-md-5">
							<p>Jesteśmy firmą z wieloletnimi tradycjami. W ofercie mamy akcesoria wędkarskie najwyższej jakości, produkowane przez liderów branży rybnej.</p>
							<p><a href="shop" class="btn btn-primary">Kupuj teraz</a></p>
						</div>
					</div>
				</div>
			</div>
      ...
      <div class="container py-4">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(myimages/bg_3.jpg);">
    	<div class="container">
